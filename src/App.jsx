...
function App() {
  ...
  return (
    <main class="w-full h-screen font-Inter overflow-hidden mx-auto bg-primary flex items-center justify-center px-4 xl:p-8 ">
        <img class="xl:hidden absolute bottom-0 w-full" src="./assets/svg/gd.svg" alt="" />
        <section
            ...
            <div class="flex flex-row w-full justify-between items-center">
                ...
                <h1 class="text-white">EN</h1>
            </div>

            <div class="w-full h-[60px] bg-[#1F1F1F] rounded-md shadow-inner text-white"></div>

            <div class="flex flex-row justify-between w-full gap-6">
                <div class="flex flex-col w-full gap-6">
                    <div class="flex flex-row gap-6  w-full justify-between">
                        <button
                            class="bg-green-600 w-1/2  py-2 rounded-lg text-white font-bold h-10 hover:scale-105 active:scale-95 transition transform">AC</button>
                        <div class="xl:flex gap-4 hidden ">
                            <button
                                class="text-white font-bold rounded-md bg-[#1F1F1F] px-4 h-10 hover:bg-[#2A2A2A] active:bg-[#454545] transition">(
                            </button>
                            <button
                                class="text-white font-bold rounded-md bg-[#1F1F1F] px-4 h-10 hover:bg-[#2A2A2A] active:bg-[#454545] transition">)
                            </button>
                    ...
                    <div class="flex flex-col h-full gap-4 w-full">
                        <button
                            class="bg-[#1F1F1F]  hover:shadow-lg active:shadow-md  duration-200 h-full font-bold p-5 rounded-lg text-white  hover:bg-[#2A2A2A] active:scale-95 transition transform">True</button>
                        <button
                            class="bg-[#1F1F1F] h-full font-bold p-5 rounded-lg text-white  hover:bg-[#2A2A2A] active:scale-95 transition transform">False</button>
                    </div>
                </div>

                <div class="flex flex-col w-full items-end gap-6">

                    <button
                        class="bg-red-600 hidden xl:flex items-center justify-center w-full h-10 rounded-lg text-white font-bold hover:bg-red-700 active:scale-95 transition transform">
                    ...
                    <div class="flex flex-row xl:hidden w-full gap-4">
                        <div class=" gap-3  flex">
                            <button
                                class="text-white font-bold rounded-md bg-[#1F1F1F] px-[10px] h-10 hover:bg-[#2A2A2A] active:bg-[#454545] transition">(
                            </button>
                            <button
                                class="text-white font-bold rounded-md bg-[#1F1F1F] px-[10px] h-10 hover:bg-[#2A2A2A] active:bg-[#454545] transition">)
                            </button>
                        ...
                        <button
                            class="bg-red-600 flex items-center justify-center w-full h-10 rounded-lg text-white font-bold hover:bg-red-700 active:scale-95 transition transform">
                    ...
                    <div class="grid xl:grid-cols-3 grid-cols-2 gap-4 w-full">
                        <button
                            class="bg-[#1F1F1F] font-bold rounded-lg flex items-center justify-center w-full xl:w-[55px] h-10 text-white hover:scale-110  hover:shadow-lg active:shadow-md  duration-200 active:scale-95 transition transform">
                        ...
                        <button
                            class="bg-[#1F1F1F] font-bold rounded-lg flex items-center justify-center w-full xl:w-[55px] h-10 text-white hover:scale-110 active:scale-95 transition transform">
                    ...
                    <button
                        class="bg-blue-600   w-full h-10  font-bold  rounded-lg  flex justify-center items-center  text-white  hover:scale-110 active:scale-95 transition transform">=</button>
